...
class Person:
    """
	A Person object collects `connections` to people who live in the same
	House at the same time. These connections form the edges of the network.
	"""
...
class House:
    """
	A House has a name (e.g. it's address), and a list of occupants.
	The occupants change when people move in or out.
	"""
    ...
    def change_occupants(self, person, add):
        ...
        if person.name == "-":
            ...
            try:
                ...
                sys.exit(
                    "Tried to remove {}, who wasn't a member of {}! "
                    "Check your input data for errors.".format(
